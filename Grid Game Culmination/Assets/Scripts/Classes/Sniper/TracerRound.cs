...
public class TracerRound : AbstractAttack
{
    public override void use(BaseBehavior initiator, BaseBehavior target, bool isOptimal)
    {
        ...
        {
            //debuff target
            TracerModifier newMod = new TracerModifier(buffAmount, buffTurns+1);
            newMod.setStrings();
        ...
        {
            //debuff target
            TracerModifier newMod = new TracerModifier(buffAmount, buffTurns);
            newMod.setStrings();
            target.Modifiers.Add(newMod);
        }
